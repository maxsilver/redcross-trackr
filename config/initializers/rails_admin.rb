...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Redcross Trackr', 'Admin']
  ...
  # config.excluded_models = ['Chapter', 'Item', 'ItemField', 'ItemFieldDefinition', 'ItemTypeDefinition', 'Location', 'Region', 'State', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Chapter', 'Item', 'ItemField', 'ItemFieldDefinition', 'ItemTypeDefinition', 'Location', 'Region', 'State', 'User']
  ...
  #     configure :item_type_definition, :belongs_to_association 
  #     configure :current_location, :belongs_to_association 
  #     configure :owner, :belongs_to_association 
  #     configure :item_fields, :has_many_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :label, :string 
  #     configure :item_type_definition_id, :integer         # Hidden 
  ...
  # config.model 'ItemField' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your item_field.rb model definition
  ...
  # config.model 'ItemFieldDefinition' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your item_field_definition.rb model definition
  ...
  # config.model 'ItemTypeDefinition' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your item_type_definition.rb model definition
  
  #   # Found associations:

  #     configure :items, :has_many_association 
  #     configure :item_field_definitions, :has_many_association 
  ...
  #     configure :chapter, :belongs_to_association 
  ...
  #     configure :national_shelter_system_identifier, :string 
